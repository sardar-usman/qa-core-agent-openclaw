...
for s in smoke-tools smoke-finish smoke-hascount smoke-planner-parse \
         ...
         smoke-pom-ambiguous smoke-filter-disambiguation; do
  echo "=== $s ==="
